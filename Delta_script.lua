...
_G.is_deltaandroid_loaded = false
...
local function C_110()
	...
	local btn = script.Parent
	btn.MouseButton1Click:Connect(function()
		setclipboard("https://discord.gg/mtnQm2mV")
        game.StarterGui:SetCore("SendNotification", 
    {
    Title = "دلتا للجوال";
    Text = "تم نسخ سيرفر الديسكورد";
    Duration = 5;
    })
...
local function C_115()
    ...
    {
    Title = "دلتا للجوال";
    Text = " RM7 تم صنع الهكر من قبل ماجد ";
    Duration = 5;
    })
