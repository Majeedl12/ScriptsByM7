...
G2L["a7"]["Name"] = [[Clipboard تشغيل السكربت ]];
...
G2L["a8"]["Text"] = [[تشغيل السكربت Clipboard]];
...
G2L["ce"]["PlaceholderText"] = [[أدخل بحثك  ...]];
...
G2L["10c"]["Text"] = [[نسخ رابط سيرفر الديسكورد]];
...
G2L["116"]["Name"] = [[فتح الفريمات]];
G2L["116"]["Text"] = [[    فتح الفريمات]];
...
local function C_aa()
	...
	btn.MouseButton1Click:Connect(function()
		...
		game.StarterGui:SetCore("SendNotification", 
            {
            Title = "Delta العرب";
            Text = "تم تشغيل السكربت من الحافظه";
            Duration = 1;
            })
	end)
end;
...
local function C_fd()
	...
	local function AddTab(imageTab, creator, scriptname, source)
		...
		loadtext.MouseButton1Click:Connect(function()
            ...
            {
            Title = "Delta العرب";
            Text = "Work In Progress / تحديث لاحقا";
            Duration = 5;
            })
...
local function C_110()
	...
	local btn = script.Parent
	btn.MouseButton1Click:Connect(function()
		setclipboard("https://discord.com/invite/AdEj6mZKRn")
        game.StarterGui:SetCore("SendNotification", 
    {
    Title = "Delta العرب";
